  ...
  return (
    <div className="floor-page">
      <div className="floor-page__info">
        <div
          className="floor-page__arrow-back"
          onClick={() => router("/MainPage")}
        >
          <ArrowBackIosNewIcon
            sx={{ color: "#187FF6", width: "68px", height: "68px" }}
          />
        </div>
        ...
        <div className="floor-page__contact-info">
          ...
          <div className="floor-page__contact-name">
            {floorId && headmans[floorId]?.secondName
              ? headmans[floorId].secondName
              : "found"}{" "}
            {floorId && headmans[floorId]?.firstName
              ? headmans[floorId].firstName
              : "Not"}
          </div>
        </div>
        <div className="floor-page__contact-info">
          <div className="floor-page__contact-elder">
            ...
            {floorId && headmans[floorId]?.tg
              ? headmans[floorId].tg
              : "Not found"}
          </div>
          <div className="floor-page__contact-name">
            <img src={phone} className="floor-page__phone" />+
            {floorId && headmans[floorId]?.phone
              ? headmans[floorId].phone
              : "Not found"}
          </div>
        </div>
      </div>
